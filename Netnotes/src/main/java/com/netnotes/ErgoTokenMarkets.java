...
public class ErgoTokenMarkets extends Network implements NoteInterface {
    public static final String NAME = "Ergo Token Markets";
    public static final String NETWORK_ID = "ERGO_TOKEN_MARKETS";
    public static final String DESCRIPTION = "Markets for Ergo tokens.";
    ...
    public ErgoTokenMarkets(ErgoNetworkData ergNetData, ErgoNetwork ergoNetwork){
    ...
    public boolean sendNote(JsonObject note, EventHandler<WorkerStateEvent> onSucceeded, EventHandler<WorkerStateEvent> onFailed) {
        ...
        if(cmdElement != null){
            ...
            NoteInterface marketData = getNetworksData().getApp(id);
    ...
    public JsonObject getMarketById(JsonObject json){
        ...
        if(idElement != null && idElement.isJsonPrimitive()){
            ...
            NoteInterface marketInterface = getNetworksData().getApp(id); 
